...
log_save_path = "train_from_scratch.log" # path to save training log 
models_save_dir = "model_from_scratch_pt" # path to save trained model
...
def train(net, data_loader, optimizer, criterion, num_epochs = 10):
    ...
    with open(log_save_path, "w+") as f: pass # clear old log
...
if __name__ == "__main__":
    ...
    net.load_state_dict(torch.load("./model_from_scratch_pt/ResNetFashion_final.pth"))
